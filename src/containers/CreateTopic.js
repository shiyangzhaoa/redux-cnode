		...
		return (
			<div style={style.body}>
				...
				<form id="create_topic" onSubmit={this.handleSubmit} style={style.content} >
					<span>选择板块：</span>
					<Select size='large' defaultValue='' name='tab' style={{ width: 200, marginBottom: 10, marginLeft: 10 }} onChange={this.handleSlecet}>
				    ...
				    <Input name='title' style={style.input_title} value={this.state.title} onChange={this.handleInput} placeholder='标题字数 十字以上' />
